...
PURPOSE:
Create master dark array that will be used to subtract imperfections from raw
target image data.

EXPLANATION:
Calls get_darks in order to begin sequence. Then takes the
median of the dark images along the 3rd axis and subtracts the master bias to
